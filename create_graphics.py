...
def create_graphics(csv_list, x_column, y_column, window, out_folder):
...
if __name__ == '__main__':
    ...
    create_graphics([os.path.join(csv_folder, element) for element in csv_list], x_column, y_column, window, out_folder)